...
public class VerExpedientesRevisados extends JFrame implements ActionListener, KeyListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VerExpedientesRevisados frame = new VerExpedientesRevisados();
	 ...
	 * Create the frame.
	 */
	public VerExpedientesRevisados() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(VerExpedientesRevisados.class.getResource("/Imagenes/reporte.png")));
		setResizable(false);
		...
		lblListadoDeExpedientes = new JLabel("Listado de Expedientes Revisados");
		...
		lblListadoDeExpedientes.setBounds(23, 23, 542, 33);
	...
	//VALIDACIONES
	 ...
	 void mostrar(String situacion) {
		GestionExpediente gu = new GestionExpediente();
		ArrayList<Expediente> resultado = gu.listado(situacion);
